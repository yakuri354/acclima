...
import org.h2gis.functions.io.shp.internal
import typing



class SHPDriverFunction(org.h2gis.api.DriverFunction):
...
class SHPEngine(org.h2gis.functions.io.file_table.FileEngine[org.h2gis.functions.io.shp.internal.SHPDriver]):
    def __init__(self): ...

class SHPRead(org.h2gis.api.AbstractFunction, org.h2gis.api.ScalarFunction):
    def __init__(self): ...
...
class SHPWrite(org.h2gis.api.AbstractFunction, org.h2gis.api.ScalarFunction):
    def __init__(self): ...
    @typing.overload
    @staticmethod
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("org.h2gis.functions.io.shp")``.

    SHPDriverFunction: typing.Type[SHPDriverFunction]
    SHPEngine: typing.Type[SHPEngine]
    SHPRead: typing.Type[SHPRead]
    SHPWrite: typing.Type[SHPWrite]
    internal: org.h2gis.functions.io.shp.internal.__module_protocol__
