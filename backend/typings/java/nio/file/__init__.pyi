...
class Watchable:
    ...
    @typing.overload
    def register(self, watchService: WatchService, kindArray: typing.Union[typing.List[WatchEvent.Kind[typing.Any]], jpype.JArray], *modifier: WatchEvent.Modifier) -> WatchKey: ...
