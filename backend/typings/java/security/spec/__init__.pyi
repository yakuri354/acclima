...
class EllipticCurve:
    ...
    @typing.overload
    def __init__(self, eCField: ECField, bigInteger: java.math.BigInteger, bigInteger2: java.math.BigInteger, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]): ...
    def equals(self, object: typing.Any) -> bool: ...
