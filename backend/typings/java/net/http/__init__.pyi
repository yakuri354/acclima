...
class HttpRequest:
    ...
    class BodyPublishers:
        ...
        @staticmethod
        def ofByteArrays(iterable: typing.Union[java.lang.Iterable[typing.Union[typing.List[int], jpype.JArray, bytes]], typing.Sequence[typing.Union[typing.List[int], jpype.JArray, bytes]], typing.Set[typing.Union[typing.List[int], jpype.JArray, bytes]]]) -> 'HttpRequest.BodyPublisher': ...
        @staticmethod
