...
class URLClassLoader(java.security.SecureClassLoader, java.io.Closeable):
    ...
    @typing.overload
    def __init__(self, string: str, uRLArray: typing.Union[typing.List[URL], jpype.JArray], classLoader: java.lang.ClassLoader, uRLStreamHandlerFactory: 'URLStreamHandlerFactory'): ...
    @typing.overload
    ...
    @typing.overload
    def __init__(self, uRLArray: typing.Union[typing.List[URL], jpype.JArray], classLoader: java.lang.ClassLoader, uRLStreamHandlerFactory: 'URLStreamHandlerFactory'): ...
    def close(self) -> None: ...
